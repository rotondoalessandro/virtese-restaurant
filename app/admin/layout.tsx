...
export default function AdminLayout({ children }: { children: ReactNode }) {
  return (
    <div className="bg-[#050505] text-zinc-50">
      {/* wrapper che riempie lo spazio sotto la navbar (h-16 = 4rem) */}
      <div className="grid min-h-[calc(100vh-4rem)] grid-cols-1 md:grid-cols-[240px_1fr] border-t border-zinc-900">
        {/* SIDEBAR */}
