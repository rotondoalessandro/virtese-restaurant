    ...
    <div className="mx-auto max-w-4xl space-y-8">
      <header className="space-y-2">
        ...
        <h1 className="font-display text-3xl leading-tight text-[#3f3127] sm:text-4xl">
          Opening hours now live in Sanity
        </h1>
        <p className="max-w-2xl text-sm leading-relaxed text-[#5b4b41]">
          Manage hours in the Sanity Studio (Contact & Location document). This page no longer edits a database.
        </p>
      </header>
      ...
      <section className="rounded-[1.25rem] border border-[#e1d6c9] bg-white/90 p-6 shadow-sm">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-[0.7rem] uppercase tracking-[0.2em] text-[#8a7463]">Where to edit</p>
            <p className="mt-1 text-sm text-[#5b4b41]">
              Open Sanity Studio and update <strong>Contact & Location - Opening hours</strong>.
            </p>
          </div>
          <Link
            href="/admin/studio"
